...
class Widget_Companies extends Widget_Base
{
    ...
    {
        return 'felan-companies';
    }

    public function get_title()
    {
        return esc_html__('Companies', 'felan-framework');
    }
    ...
    {
        return [FELAN_PLUGIN_PREFIX . 'companies'];
    }
    ...
    private function register_layout_section()
    {
        ...
        $this->add_control('layout', [
            ...
            'options' => [
                'layout-list' => esc_html__('Layout Default List', 'felan-framework'),
                'layout-grid' => esc_html__('Layout Default Grid', 'felan-framework'),
                'layout-thumbnail-list' => esc_html__('Layout Thumbnail List', 'felan-framework'),
                'layout-thumbnail-grid' => esc_html__('Layout Thumbnail Grid', 'felan-framework'),
                'layout-button-jobs' => esc_html__('Layout Button Jobs', 'felan-framework'),
                'layout-follow-bottom'  => esc_html__('Layout Follow Bottom', 'felan-framework'),
            ],
            'default' => 'layout-list',
        ]);
    ...
    private function register_layout_style_section()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .felan-company-item',
            ]
        );
        ...
        $this->add_control('box_padding', [
            ...
            'size_units' => ['px', '%'],
            'selectors'  => [
                '{{WRAPPER}} .felan-company-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_control('layout_border_radius', [
            ...
            'size_units' => ['px', '%'],
            'selectors'  => [
                '{{WRAPPER}} .felan-company-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('wrapper', 'class', 'felan-companies');
        $args = array(
        ...
        if ($settings['type_query'] == 'taxonomy') {
            $taxonomies = array("company-categories", "felan_location", "company-size");
...
?>
        <div <?php echo $this->get_render_attribute_string('wrapper') ?>>
            <?php if ($data->have_posts()) { ?>
                ...
                <?php } else { ?>
                    <div class="elementor-grid-companies">
