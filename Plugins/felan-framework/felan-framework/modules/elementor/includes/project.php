...
Plugin::instance()->widgets_manager->register(new Widget_Project());

class Widget_Project extends Widget_Base
{
    ...
    {
        return 'felan-project';
    }

    public function get_title()
    {
        return esc_html__('Project', 'felan-framework');
    }
    ...
    {
        return [FELAN_PLUGIN_PREFIX . 'project'];
    }
    ...
    private function register_layout_section()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-carousel .project-item-inner' => 'padding-left: calc({{SIZE}}{{UNIT}}/2); padding-right: calc({{SIZE}}{{UNIT}}/2)',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-carousel .project-item-inner' => 'padding-top: calc({{SIZE}}{{UNIT}}/2); padding-bottom: calc({{SIZE}}{{UNIT}}/2)',
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('wrapper', 'class', 'felan-project');
        $args = array(
        ...
        if ($settings['type_query'] == 'taxonomy') {
            $taxonomies = array("project-categories", "felan_location", "project-size");
...
?>
        <div <?php echo $this->get_render_attribute_string('wrapper') ?>>
            <?php if ($data->have_posts()) { ?>
                            ...
                            <?php while ($data->have_posts()) : $data->the_post(); ?>
                                <div class="project-item-inner">
                                    <?php felan_get_template('content-project.php', array(
                                        'in_elementor'    => true,
                                        'project_layout' => $settings['layout'],
                                        'custom_project_image_size' => $settings['image_size'],
                                    )); ?>
                                </div>
                            <?php endwhile; ?>
                        </div>
                ...
                <?php } else { ?>
                    <div class="elementor-grid-project" dir="<?php echo esc_attr($direction); ?>">
