    ...
    <div class="company-fields company-additional row">
        ...
        ?>
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" id="<?php echo esc_attr($field['id']); ?>" class="form-control" name="<?php echo esc_attr($field['id']); ?>" value="<?php if (isset($company_meta_data[$field['id']])) {
                    ...
                    ?>
                        <div class="form-group col-lg-6">
                            <label><?php esc_html_e($field['title']); ?></label>
                            <input type="url" id="<?php echo esc_attr($field['id']); ?>" class="form-control" name="<?php echo esc_attr($field['id']); ?>" value="<?php if (isset($company_meta_data[$field['id']])) {
                                                                                                                                                                        echo sanitize_text_field($company_meta_data[$field['id']][0]);
                    ...
                    ?>
                        <div class="form-group col-12">
                            <label><?php esc_html_e($field['title']); ?></label>
                            <textarea name="<?php echo esc_attr($field['id']); ?>" rows="6" id="<?php echo esc_attr($field['id']); ?>" class="form-control"><?php if (isset($company_meta_data[$field['id']])) {
                                                                                                                                                                echo sanitize_text_field($company_meta_data[$field['id']][0]);
                                                                                                                                                            } ?></textarea>
                        </div>
                    <?php
                    ...
                    case 'image':
                        ...
                        $company_field = get_post_meta($company_data->ID, $field['id'], true);
                        $custom_image_id = !empty($company_field['id']) ? $company_field['id'] : '';
                        $custom_image_url = !empty($company_field['url']) ? $company_field['url'] : '';
                    ?>
                        ...
                        <div class="felan-field-<?php echo esc_attr($field['id']); ?>">
                            ...
                            <div id="felan_cv_plupload_container" class="file-upload-block preview" style="display: inline-block;">
                                <div class="felan_cv_file felan_add-cv">
                                    <p class="drop-cv-<?php echo esc_attr($field['id']); ?>" id="felan_drop_cv" data-attachment-id="<?php echo esc_attr($company_field);?>">
