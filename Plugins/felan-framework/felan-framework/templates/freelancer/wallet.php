...
<div class="felan-freelancer-withdraw entry-my-page">
    <div class="entry-title">
        ...
        <div class="button-warpper">
            ...
            <?php } ?>
            <a href="#form-freelancer-withdraw" class="felan-button" id="btn-freelancer-withdraw">
        ...
        <div class="tab-dashboard">
            ...
            <div class="tab-content">
                <div class="tab-info" id="tab-withdrawals">
                    <?php felan_get_template('freelancer/wallet/withdrawals.php'); ?>
                </div>
                <div class="tab-info" id="tab-topup">
                    <?php felan_get_template('freelancer/wallet/topup.php'); ?>
                </div>
            </div>
        </div>
    <?php else: ?>
