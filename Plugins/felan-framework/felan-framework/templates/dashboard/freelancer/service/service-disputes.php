...
wp_enqueue_script(FELAN_PLUGIN_PREFIX . 'freelancer-disputes');
wp_localize_script(
    FELAN_PLUGIN_PREFIX . 'freelancer-disputes',
    'felan_disputes_vars',
    array(
    ...
    <?php if ($data->have_posts()) { ?>
        <div class="table-dashboard-wapper">
            <table class="table-dashboard" id="disputes">
                <thead>
                <tr>
                    <th><?php esc_html_e('Service Name', 'felan-framework') ?></th>
                ...
                <?php while ($data->have_posts()) : $data->the_post(); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo esc_url(felan_get_permalink('freelancer_disputes')); ?>?order_id=<?php echo esc_attr($order_id) ?>&disputes_id=<?php echo esc_attr($disputes_id) ?>"
