...
wp_enqueue_script(FELAN_PLUGIN_PREFIX . 'project-disputes-detail');
wp_localize_script(
    FELAN_PLUGIN_PREFIX . 'project-disputes-detail',
    'felan_project_disputes_detail_vars',
    array(
...
$applicants_id = isset($_GET['order_id']) ? felan_clean(wp_unslash($_GET['order_id'])) : '';
...
$receive_messages = get_user_meta($author_id, FELAN_PLUGIN_PREFIX . 'disputes_project_messages_employer_' . $disputes_id, true);
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="order-content">
                        ...
                        <ul class="budget-inner">
                            ...
                            <?php if($projects_budget_show == 'fixed'): ?>
                                <li class="list-item-budget">
                                    ...
                                    <span class="price"><?php echo esc_html($proposal_maximum_time)?></span>
                                </li>
                            <?php endif; ?>
                        ...
                        <?php if ($status == 'open') : ?>
                            <div class="order-status">
                                <?php if ($user_demo == 'yes') { ?>
                                    <a class="felan-button btn-add-to-message mr-3"
                                       data-text="<?php echo esc_attr('Oops! Sorry. This action is restricted on the demo site.', 'felan-framework'); ?>" href="#">
                                        <?php esc_html_e('Approve', 'felan-framework') ?>
                                    </a>
                                    <a class="felan-button button-outline btn-add-to-message"
                                       data-text="<?php echo esc_attr('Oops! Sorry. This action is restricted on the demo site.', 'felan-framework'); ?>" href="#">
                                        <?php esc_html_e('Deny', 'felan-framework') ?>
                                    </a>
                                <?php } else { ?>
                                    <a href="#" class="felan-button btn-approve" style="margin-right: 10px">
                                        <?php echo esc_html__('Approve', 'felan-framework') ?>
                                        <span class="btn-loading"><i class="far fa-spinner fa-spin medium"></i></span>
                                    </a>
                                    <a href="#" class="felan-button button-outline btn-canceled">
                                        <?php echo esc_html__('Deny', 'felan-framework') ?>
                                        <span class="btn-loading"><i class="far fa-spinner fa-spin medium"></i></span>
                                    </a>
                                <?php } ?>
                            </div>
                    ...
                    <input type="hidden" name="order_price" value="<?php echo esc_attr($proposal_price); ?>">
                        ...
                        <div class="list-chat">
                            ...
                            <?php if ($status == 'open') : ?>
                                <div class="order-chat">
                                    <form id="felan-form-message-disputes">
                                        ...
                                        <input type="hidden" name="disputes_id" id="disputes_id"
                                               value="<?php echo esc_attr($disputes_id); ?>">
