...
<?php
    ...
    case 'file':
        ...
        <div class="form-group col-12 felan-fields-custom_upload">
            <label><?php esc_html_e($field['title']); ?></label>
            <div class="felan-field-<?php echo esc_attr($field['id']); ?>">
                <div id="cv_custom_cerrors_log" class="errors-log"></div>
                <div id="felan_custom_cv_plupload_container" class="file-upload-block preview" style="display: inline-block;">
                    <div class="felan_custom_cv_file felan_add-cv">
                        <p class="drop-cv-<?php echo esc_attr($field['id']); ?>" id="felan_custom_drop_cv" data-attachment-id="<?php echo esc_attr($freelancer_field);?>">
                            <button class="felan-button" type="button" id="felan_custom_select_cv">
                                <i class="far fa-arrow-from-bottom large"></i>
                                <span>
