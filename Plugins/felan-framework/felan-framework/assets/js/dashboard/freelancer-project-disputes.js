(function ($) {
    ...
    var disputes_dashboard = $(".felan-project-disputes"),
        ajax_url = felan_project_disputes_vars.ajax_url,
        not_disputes = felan_project_disputes_vars.not_disputes;
    ...
    $(document).ready(function () {
        ...
        function ajax_load() {
            ...
            $.ajax({
                ...
                url: ajax_url,
                data: {
                    action: "felan_freelancer_project_disputes",
