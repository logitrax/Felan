...
(function (t) {
  ...
  FREELANCER_REVIEW = {
    ...
    submit_review: function () {
      var n = felan_freelancer_review_vars.ajax_url;
      var a = t(".freelancer-review-details");
      ...
      t(".reviewForm").validate({
        ...
        submitHandler: function (e) {
          var a = t(".reviewForm").find("#btn-submit-review");
          var r = t(".reviewForm");
          var i = false;
          if (window.FormData) {
            i = new FormData(r[0]);
  ...
  t(document).ready(FREELANCER_REVIEW.init());
})(jQuery);
