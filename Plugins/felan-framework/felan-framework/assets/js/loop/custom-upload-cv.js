    ...
    $(document).ready(function () {
        var featured_image = function () {
            var uploader_featured_image = new plupload.Uploader({
                browse_button: "felan_custom_select_cv",
                file_data_name: "felan_thumbnail_upload_file",
                drop_element: "felan_custom_select_cv",
                container: "felan_custom_cv_plupload_container",
                url: url,
                filters: {
                    mime_types: [
                        {
            ...
            uploader_featured_image.bind("Error", function (up, err) {
                document.getElementById("cv_custom_cerrors_log").innerHTML +=
            ...
            uploader_featured_image.bind(
                ...
                function (up, file, ajax_response) {
                    ...
                    if (response.success) {
                        ...
                        $("#felan_custom_drop_cv").attr(
                            "data-attachment-id",
                            response.attachment_id
                        );
                        $("#felan_custom_drop_cv .cv-icon-delete").remove();
                        $("#felan_custom_drop_cv").append(
                        ...
                        var $html =
                            ...
                            response.title +
                            "</span>";
                        $("#felan_custom_select_cv i").addClass("far fa-arrow-from-bottom large");
                        $("#felan_custom_select_cv").html($html);
                        $("#cv_custom_url-error").hide();
            ...
            $("body").on("click", ".cv-icon-delete", function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            $("#cv_custom_url-error").show();
                            $(".felan_custom_cv_file").show();
                        }
                        $("#felan_custom_select_cv").html(text);
                        $("#felan_custom_drop_cv").attr("data-attachment-id", "");
                        $("#freelancer-profile-form").find(".point-mark").change();
                        icon_delete.remove();
                    },
                    error: function () {
