...
(function (t) {
  ...
  COMPANY_REVIEW = {
    ...
    submit_review: function () {
      var n = felan_company_review_vars.ajax_url;
      var a = t(".company-review-details");
      a.find("input:file").change(function () {
        t(".fileList span").remove();
        for (var e = 0; e < this.files.length; e++) {
          var a = this.files[e].name;
          t(".fileList").append("<span>" + a + "</span>");
        }
      });
      a.find(".entry-nav .reply").on("click", function (e) {
        e.preventDefault();
        t(".author-review").removeClass("active");
        t(".author-review .form-reply").html("");
        var a = t(this);
        var r = t(".duplicate-form-reply").html();
        var i = a.parents(".author-review").find(".form-reply").data("id");
        t(".add-new-review").hide();
      ...
      t("body").on("click", ".cancel-reply", function (e) {
        e.preventDefault();
        a.find(".author-review").removeClass("active");
        a.find(".author-review .form-reply").html("");
        a.find(".add-new-review").show();
      });
      t.validator.setDefaults({ debug: true, success: "valid" });
      t(".reviewForm").validate({
        ...
        submitHandler: function (e) {
          var a = t(".reviewForm").find(".felan-submit-company-rating");
          var r = t(".reviewForm");
          var i = false;
          if (window.FormData) {
            i = new FormData(r[0]);
  ...
  t(document).ready(COMPANY_REVIEW.init());
})(jQuery);
