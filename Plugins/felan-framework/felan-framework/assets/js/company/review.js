var COMPANY_REVIEW = COMPANY_REVIEW || {};
...
(function ($) {
  ...
  COMPANY_REVIEW = {
    ...
    submit_review: function () {
      ...
      var company_review = $(".company-review-details");

      company_review.find("input:file").change(function () {
      ...
      company_review.find(".entry-nav .reply").on("click", function (e) {
        e.preventDefault();
      ...
      $("body").on(
        "click",
        ".form-reply .felan-submit-company-reply",
        function (e) {
          e.preventDefault();
          var $this = $(this);
      ...
      $("body").on("click", ".cancel-reply", function (e) {
        e.preventDefault();
        company_review.find(".author-review").removeClass("active");
        company_review.find(".author-review .form-reply").html("");
        company_review.find(".add-new-review").show();
      });
  ...
  $(document).ready(COMPANY_REVIEW.init());
})(jQuery);
