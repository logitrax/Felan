 ...
 * can be found at <a
 * href="https://stripe.com/docs/api#project_products">Subscription Products</a>.
 *
 * Related guide: <a
 ...
 * @property null|\MyStripe\StripeObject $package_dimensions The dimensions of this product for shipping purposes. A SKU associated with this product can override this value by having its own <code>package_dimensions</code>. Only applicable to products of <code>type=good</code>.
 ...
 * @property string $type The type of the product. The product is either of type <code>good</code>, which is eligible for use with Orders and SKUs, or <code>project</code>, which is eligible for use with Subscriptions and Plans.
