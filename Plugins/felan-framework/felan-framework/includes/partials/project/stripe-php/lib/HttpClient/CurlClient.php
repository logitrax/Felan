...
namespace MyStripe\HttpClient;

use MyStripe\Exception;
use MyStripe\Stripe;
use MyStripe\Util;
...
class CurlClient implements ClientInterface
{
    ...
    /** @var \MyStripe\Util\RandomGenerator */
     ...
     * @param null|\MyStripe\Util\RandomGenerator $randomGenerator
     */
     ...
     *   <li>\MyStripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
        ...
        switch ($errno) {
            ...
            case \CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to Stripe ({$url}).  Please check your "
                 ...
                 . "you should check Stripe's project status at "
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\MyStripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
