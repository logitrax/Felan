...
class Widget_Image_Layers extends Base
{
	...
	{
		return 'felan-image-layers';
	}

	public function get_title()
	{
		return esc_html__('Image Layers', 'felan');
	}
	...
	{
		return ['felan-el-widget-image-layers'];
	}
	...
	private function add_artboard_section()
	{
		$this->start_controls_section('artboard_section', [
			'label' => esc_html__('Artboard', 'felan'),
		]);
	...
	private function add_layers_section()
	{
		$this->start_controls_section('layers_section', [
			'label' => esc_html__('Layers', 'felan'),
		]);

		$repeater = new Repeater();

		$repeater->add_control('static', [
			'label' => esc_html__('Static Layer', 'felan'),
		...
		$repeater->add_control('loop', [
			...
			'options' => [
				...
				'rotate'          => esc_html__('Rotate', 'felan'),
				'move-horizontal' => esc_html__('Move - Horizontal', 'felan'),
				'move-vertical'   => esc_html__('Move - Vertical', 'felan'),
			],
			'default' => '',
		]);
