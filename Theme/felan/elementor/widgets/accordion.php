...
class Widget_Accordion extends Base
{
	...
	{
		return 'felan-accordion';
	}

	public function get_title()
	{
		return esc_html__('Modern Accordion/Toggle', 'felan');
	}
	...
	{
		return ['felan-widget-accordion'];
	}

	public function get_style_depends()
	{
		return ['felan-el-widget-accordion'];
	}
	...
	private function add_content_section()
	{
		...
		$this->add_control('style', [
			...
			'prefix_class' => 'felan-accordion-style-',
		]);
		...
		$this->add_control('active_first_item', [
			'label'              => esc_html__('Active First Item', 'felan'),
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', 'felan-accordion');
...
?>
	...
	protected function content_template()
	{
		// @formatter:off
	?>
		<# var iconHTML=elementor.helpers.renderIcon( view, settings.icon, { 'aria-hidden' : true }, 'i' , 'object' ); var iconActiveHTML=elementor.helpers.renderIcon( view, settings.active_icon, { 'aria-hidden' : true }, 'i' , 'object' ); view.addRenderAttribute( 'wrapper' , 'class' , 'felan-accordion' ); if ( 'toggle'===settings.type ) { view.addRenderAttribute( 'wrapper' , 'data-multi-open' , '1' ); } if ( iconHTML.rendered ) { view.addRenderAttribute( 'wrapper' , 'class' , 'felan-accordion-icon-' + settings.icon_align); } var loopCount=0; #>
