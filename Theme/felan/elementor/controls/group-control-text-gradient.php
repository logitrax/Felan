...
class Group_Control_Text_Gradient extends Group_Control_Base
{
	...
	private static function get_default_color_types()
	{
		return [
			'classic'  => [
				'title' => _x('Solid', 'Text Gradient Control', 'felan'),
				'icon'  => 'eicon-paint-brush',
			],
			'gradient' => [
				'title' => _x('Gradient', 'Text Gradient Control', 'felan'),
				'icon'  => 'eicon-barcode',
			],
		];
	}
	...
	public function init_fields()
	{
		...
		$fields['color_type'] = [
			'label'       => esc_html__('Color Type', 'felan'),
		...
		$fields['color_a'] = [
			'label'       => esc_html__('First Color', 'felan'),
			'type'        => Controls_Manager::COLOR,
			'default'     => '#5758DF',
			'render_type' => 'ui',
			'condition'   => [
		...
		$fields['color_a_stop'] = [
			'label'       => _x('Location', 'Text Gradient Control', 'felan'),
		...
		$fields['color_b'] = [
			'label'       => esc_html__('Second Color', 'felan'),
			'type'        => Controls_Manager::COLOR,
			'default'     => '#F77991',
			'render_type' => 'ui',
			'condition'   => [
		...
		$fields['gradient_angle'] = [
			'label'      => _x('Angle', 'Text Gradient Control', 'felan'),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => ['deg'],
			'default'    => [
				'unit' => 'deg',
