(function (e) {
  "use strict";
  var i = function (e, i) {
    var n = e.find(".felan-slider-widget");
    n.FelanSwiper();
  };
  var n = function (e, i) {
    var n = e.find(".felan-slider-widget");
    if (e.hasClass("felan-swiper-linked-yes")) {
      var r = n.filter(".felan-thumbs-swiper").FelanSwiper();
      var t = n
        .filter(".felan-main-swiper")
        .FelanSwiper({ thumbs: { swiper: r } });
    } else {
      n.FelanSwiper();
    }
  };
