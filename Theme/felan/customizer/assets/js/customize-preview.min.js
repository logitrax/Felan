(function (c) {
  ...
  function o(e, t) {
    e.removeClass(function (e, o) {
      return (o.match(new RegExp("\\b" + t + "\\S+", "g")) || []).join(" ");
    });
  }
  wp.customize("primary_color", function (e) {
    e.bind(function (e) {
      var o =
  ...
  wp.customize("text_color", function (e) {
    e.bind(function (e) {
      var o =
  ...
  wp.customize("accent_color", function (e) {
    e.bind(function (e) {
      var o =
      ...
      c(o).css("color", e);
      c(r).css("background", e);
      c(n).css("border-color", e);
      a(t, "{ color: " + e + "}");
      a(i, "{ background: " + e + "}");
      a(
        ...
        "{ background: transparent!important;color:" + e + "}"
      );
      a(
        ".felan-dual-ring:after,.felan-ldef-hourglass:after,.felan-ldef-dual-ring:after",
        "{ border-color: " + e + " transparent " + e + " transparent}"
      );
      a(
      ...
      a(
        ...
        "{ background: " + e + ";box-shadow: " + e + " 0 1px 3px 0 inset}"
      );
    });
  });
  wp.customize("body_background_color", function (e) {
    e.bind(function (e) {
      c("body").css("background-color", e);
    });
  });
  wp.customize("bg_body_image", function (e) {
    e.bind(function (e) {
      c("body").css("background-image", e);
    });
  });
  wp.customize("bg_body_size", function (e) {
    e.bind(function (e) {
      c("body").css("background-size", e);
    });
  });
  wp.customize("bg_body_repeat", function (e) {
    e.bind(function (e) {
      c("body").css("background-repeat", e);
    });
  });
  wp.customize("bg_body_position", function (e) {
    e.bind(function (e) {
      c("body").css("background-position", e);
    });
  });
  wp.customize("bg_body_attachment", function (e) {
    e.bind(function (e) {
      c("body").css("background-attachment", e);
    });
  });
  wp.customize("layout_content", function (e) {
    e.bind(function (e) {
      c("#wrapper").removeClass();
      c("#wrapper").addClass(e);
      c("#wrapper").css("max-width", "auto");
    });
  });
  wp.customize("content_width", function (e) {
    e.bind(function (e) {
      var e = e + "px";
      c("#wrapper").css("max-width", e);
    });
  });
  wp.customize("layout_sidebar", function (e) {
    e.bind(function (e) {
      if (c(".site-layout aside#secondary").length > 0) {
        c(".site-layout").removeClass(
          "left-sidebar right-sidebar no-sidebar has-sidebar"
        );
        if (e != "no-sidebar") {
          c(".site-layout").addClass("has-sidebar");
        }
        c(".site-layout").addClass(e);
      }
    });
  });
  wp.customize("sidebar_width", function (e) {
    e.bind(function (e) {
      var o = c(".site-layout #primary").outerWidth();
      var t = o - e;
      if (c(".site-layout aside#secondary").length > 0) {
        c(".site-layout aside#secondary").css(
          "cssText",
          "flex: 0 0 " + e + "px!important; max-width:" + e + "px!important"
        );
        c(".site-layout #primary").css(
          "cssText",
          "max-width: calc(100% - " + t + ")px!important"
        );
      }
    });
  });
  wp.customize("sticky_header", function (e) {
    e.bind(function (e) {
      if (e) {
        c("header.site-header").addClass("sticky-header");
      } else {
        c("header.site-header").removeClass("sticky-header");
      }
    });
  });
  wp.customize("float_header", function (e) {
    e.bind(function (e) {
      if (e) {
        c("header.site-header").addClass("float-header");
      } else {
        c("header.site-header").removeClass("float-header");
      }
    });
  });
  wp.customize("header_sticky_background", function (e) {
    e.bind(function (e) {
      var o = "header.site-header.sticky-header.on";
      c(o).css("background-color", e);
    });
  });
  wp.customize("logo_width", function (e) {
    e.bind(function (e) {
      var e = e + "px";
      c("header.site-header .site-logo img").css("max-width", e);
    });
  });
  wp.customize("header_padding_top", function (e) {
    e.bind(function (e) {
      var e = e + "px";
      c("header.site-header").css("padding-top", e);
    });
  });
  wp.customize("header_padding_bottom", function (e) {
    e.bind(function (e) {
      var e = e + "px";
      c("header.site-header").css("padding-bottom", e);
    });
  });
  wp.customize("show_destinations", function (e) {
    e.bind(function (e) {
      if (e) {
        c(".site-header .dropdown-categories").show();
      } else {
        c(".site-header .dropdown-categories").hide();
      }
    });
  });
  wp.customize("enable_page_title_blog", function (e) {
    e.bind(function (e) {
      if (e) {
        c(".page-title-blog").removeClass("hide");
      } else {
        c(".page-title-blog").addClass("hide");
      }
    });
  });
  wp.customize("style_page_title_blog", function (e) {
    e.bind(function (e) {
      c(".page-title-blog").css("font-style", e);
    });
  });
  wp.customize("page_title_blog_name", function (e) {
    e.bind(function (e) {
      c(".page-title-blog .entry-title").text(e);
    });
  });
  wp.customize("page_title_blog_des", function (e) {
    e.bind(function (e) {
      c(".page-title-blog .sub-title p").text(e);
    });
  });
  wp.customize("bg_page_title_blog", function (e) {
    e.bind(function (e) {
      c(".page-title-blog").css("background-color", e);
    });
  });
  wp.customize("color_page_title_blog", function (e) {
    e.bind(function (e) {
      c(".page-title-blog,.page-title-blog .entry-detail .entry-title").css(
        "color",
        e
      );
    });
  });
  wp.customize("bg_image_page_title_blog", function (e) {
    e.bind(function (e) {
      c(".page-title-blog").css("background-image", e);
    });
  });
  wp.customize("bg_size_page_title_blog", function (e) {
    e.bind(function (e) {
      c(".page-title-blog").css("background-size", e);
    });
  });
  wp.customize("bg_repeat_page_title_blog", function (e) {
    e.bind(function (e) {
      c(".page-title-blog").css("background-repeat", e);
    });
  });
  wp.customize("bg_position_page_title_blog", function (e) {
    e.bind(function (e) {
      c(".page-title-blog").css("background-position", e);
    });
  });
  wp.customize("bg_attachment_page_title_blog", function (e) {
    e.bind(function (e) {
      c(".page-title-blog").css("background-attachment", e);
    });
  });
  wp.customize("font_size_page_title_blog", function (e) {
    e.bind(function (e) {
      var e = e + "px";
      c(".page-title-blog .entry-title").css("font-size", e);
    });
  });
  wp.customize("letter_spacing_page_title_blog", function (e) {
    e.bind(function (e) {
      var e = e + "px";
      c(".page-title-blog .entry-title").css("letter-spacing", e);
    });
  });
  wp.customize("blog_sidebar", function (e) {
    e.bind(function (e) {
      if (c(".content-blog .site-layout aside#secondary").length > 0) {
        c(".content-blog .site-layout").removeClass(
          "left-sidebar right-sidebar no-sidebar has-sidebar"
        );
        if (e != "no-sidebar") {
          c(".site-layout").addClass("has-sidebar");
        }
        c(".content-blog .site-layout").addClass(e);
      }
    });
  });
  wp.customize("blog_sidebar_width", function (e) {
    e.bind(function (e) {
      var o = c(".content-blog .site-layout #primary").outerWidth();
      var t = o - e;
      if (c(".content-blog .site-layout aside#secondary").length > 0) {
        c(".content-blog .site-layout aside#secondary").css(
          "cssText",
          "flex: 0 0 " + e + "px!important; max-width:" + e + "px!important"
        );
        c(".content-blog .site-layout #primary").css(
          "cssText",
          "max-width: calc(100% - " + t + ")px!important"
        );
      }
  ...
  wp.customize("blog_number_column", function (e) {
    e.bind(function (e) {
      o(c(".archive-post"), "columns-");
      c(".archive-post").addClass(e);
    });
  });
  wp.customize("post_single_sidebar", function (e) {
    e.bind(function (e) {
      if (c(".single-post .site-layout aside#secondary").length > 0) {
        c(".single-post .site-layout").removeClass(
          "left-sidebar right-sidebar no-sidebar has-sidebar"
        );
        if (e != "no-sidebar") {
          c(".site-layout").addClass("has-sidebar");
        }
        c(".single-post .site-layout").addClass(e);
      }
    });
  });
  wp.customize("shop_layout_content", function (e) {
    e.bind(function (e) {
      c(".woocommerce #content .main-content>.inner-content").removeClass(
        "container fullwidth"
      );
      c(".woocommerce #content .main-content>.inner-content").addClass(e);
    });
  });
  wp.customize("shop_sidebar", function (e) {
    e.bind(function (e) {
      if (
        c(".woocommerce .content-shop .site-layout aside#secondary").length > 0
      ) {
        c(".woocommerce .content-shop .site-layout").removeClass(
          "left-sidebar right-sidebar no-sidebar has-sidebar"
        );
        if (e != "no-sidebar") {
          c(".woocommerce .content-shop .site-layout").addClass("has-sidebar");
        }
        c(".woocommerce .content-shop .site-layout").addClass(e);
      }
    });
  });
  wp.customize("shop_sidebar_width", function (e) {
    e.bind(function (e) {
      var o = c(".content-shop .site-layout #primary").outerWidth();
      var t = o - e;
      if (
        c(".woocommerce .content-shop .site-layout aside#secondary").length > 0
      ) {
        c(".woocommerce .content-shop .site-layout aside#secondary").css(
          "cssText",
          "flex: 0 0 " + e + "px!important; max-width:" + e + "px!important"
        );
        c(".woocommerce .content-shop .site-layout #primary").css(
          "cssText",
          "max-width: calc(100% - " + t + ")px!important"
        );
      }
  ...
  wp.customize("shop_number_column", function (e) {
    e.bind(function (e) {
      o(c(".woocommerce .archive-product"), "columns-");
      c(".woocommerce .archive-product").addClass(e);
    });
  });
  wp.customize("single_sidebar", function (e) {
    e.bind(function (e) {
      if (
        c(".woocommerce .content-single .site-layout aside#secondary").length >
        0
      ) {
        c(".woocommerce .content-single .site-layout").removeClass(
          "left-sidebar right-sidebar no-sidebar has-sidebar"
        );
        if (e != "no-sidebar") {
          c(".woocommerce .content-single .site-layout").addClass(
            "has-sidebar"
          );
        }
        c(".woocommerce .content-single .site-layout").addClass(e);
      }
    });
  });
  wp.customize("page_title_bg_color", function (e) {
    e.bind(function (e) {
      c(".page-title-orther").css("background-color", e);
    });
  });
  wp.customize("page_title_text_color", function (e) {
    e.bind(function (e) {
      c(".page-title-orther,.page-title-orther .entry-detail .entry-title").css(
        "color",
        e
      );
    });
  });
  wp.customize("page_title_bg_image", function (e) {
    e.bind(function (e) {
      c(".page-title-orther").css("background-image", e);
    });
  });
  wp.customize("page_title_bg_size", function (e) {
    e.bind(function (e) {
      c(".page-title-orther").css("background-size", e);
    });
  });
  wp.customize("page_title_bg_repeat", function (e) {
    e.bind(function (e) {
      c(".page-title-orther").css("background-repeat", e);
    });
  });
  wp.customize("page_title_bg_position", function (e) {
    e.bind(function (e) {
      c(".page-title-orther").css("background-position", e);
    });
  });
  wp.customize("page_title_bg_attachment", function (e) {
    e.bind(function (e) {
      c(".page-title-orther").css("background-attachment", e);
    });
  });
  wp.customize("page_title_font_size", function (e) {
    e.bind(function (e) {
      var e = e + "px";
      c(".page-title-orther .entry-title").css("font-size", e);
    });
  });
  wp.customize("page_title_letter_spacing", function (e) {
    e.bind(function (e) {
      var e = e + "px";
      c(".page-title-orther .entry-title").css("letter-spacing", e);
    });
  });
})(jQuery);
